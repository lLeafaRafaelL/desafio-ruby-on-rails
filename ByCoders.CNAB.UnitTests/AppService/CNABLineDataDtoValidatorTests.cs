...
public class CNABLineDataDtoValidatorTests
{
    private readonly CNABLineDataDtoValidator _validator;

    public CNABLineDataDtoValidatorTests()
    {
        _validator = new CNABLineDataDtoValidator();
    }
    ...
    // Helper method
    private CNABLineDataDto CreateValidDto()
    {
